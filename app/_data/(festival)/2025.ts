...
export const festival2025Data: FestivalData = {
  ...
  presentation: {
    posterUrl: '/images/festival/2025/affiche_festival.jpeg',
    teaserUrl:
      'https://player.vimeo.com/video/1070296014?title=0&byline=0&portrait=0',
  },

  photos: [
    '/images/festival/2025/photos/1.jpeg',
    '/images/festival/2025/photos/2.jpeg',
    '/images/festival/2025/photos/3.jpeg',
    '/images/festival/2025/photos/4.jpeg',
    '/images/festival/2025/photos/5.jpeg',
    '/images/festival/2025/photos/6.jpeg',
    '/images/festival/2025/photos/7.jpeg',
    '/images/festival/2025/photos/8.jpeg',
    '/images/festival/2025/photos/9.jpeg',
  ],
  programme: [
    {
      day: 1,
  ...
  films: [
    {
      ...
      duration: '21',
      imageUrl: '/images/festival/2025/films/1_red_flag.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '25',
      imageUrl: '/images/festival/2025/films/2_les_chiffonniers.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '18',
      imageUrl: '/images/festival/2025/films/3_ce_qui_appartient_a_cesar.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '13',
      imageUrl: '/images/festival/2025/films/4_les_talons_de_ma_mere.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '16',
      imageUrl: '/images/festival/2025/films/5_karateka.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '21',
      imageUrl: '/images/festival/2025/films/6_quitter_paris.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '19',
      imageUrl: '/images/festival/2025/films/7_les_liens_du_sang.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '25',
      imageUrl: '/images/festival/2025/films/8_boucan.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '26',
      imageUrl: '/images/festival/2025/films/9_suleyman.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '13',
      imageUrl: '/images/festival/2025/films/10_les_petits_monstres.jpg',
      synopsis:
    ...
    },
    {
      ...
      director: 'Léna Dana',
      duration: '8',
      imageUrl: '/images/festival/2025/films/11_avec_alice.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '28',
      imageUrl: '/images/festival/2025/films/12_les_dernieres_neiges.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '23',
      imageUrl: '/images/festival/2025/films/13_big_boys_dont_cry.jpeg',
      synopsis:
    ...
    },
    {
      ...
      duration: '16',
      imageUrl:
        '/images/festival/2025/films/14_le_reste_n_a_pas_d_importance.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '20',
      imageUrl: '/images/festival/2025/films/15_le_mariage_force.jpg',
      synopsis:
    ...
    },
    {
      ...
      duration: '24',
      imageUrl:
        '/images/festival/2025/films/16_les_mysterieuses_aventures_de_claude_conseil.jpeg',
      synopsis:
  ...
  parrain: {
    ...
    posterUrl: '/images/festival/2025/affiche_parrain.jpg',
    videoUrl:
  ...
  partners: [
    {
      ...
      imageUrl: '/images/festival/partenaires/LSO.jpg',
      url: 'https://www.laseptiemeobsession.com/',
    },
    {
      name: 'Le Grand Action',
      imageUrl: '/images/festival/partenaires/GA.png',
    ...
    {
      name: 'Messina Films',
      imageUrl: '/images/festival/partenaires/MF.png',
      url: 'https://www.instagram.com/messina_films',
    },
    {
      name: 'Black and White',
      imageUrl: '/images/festival/partenaires/BW.png',
      url: 'https://www.movinmotion.com/',
    },
    {
      name: 'Bref Cinéma',
      imageUrl: '/images/festival/partenaires/BC.jpg',
      url: 'https://www.brefcinema.com/',
    },
    {
      name: 'Superposé',
      imageUrl: '/images/festival/partenaires/SPP.png',

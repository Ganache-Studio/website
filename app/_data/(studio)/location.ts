import { LocationPresentation } from '../../_types/location-presentation.type';

export const locationPresentations: LocationPresentation[] = [
  {
    name: 'STATION DE MONTAGE',
    descriptions: [
      'MAC STUDIO M2 MAX',
      '2 MONITORS + TV MONITOR',
      'RESOLVE + PREMIERE',

...
const Festival = () => {
  return (
    <Section id="presentation">
      ...
      <iframe className="aspect-video w-full" src={festival2025Data.presentation.teaserUrl} allowFullScreen />
    </Section>
  );
};
    ...
    <Section id="programme">
      ...
      <div className="space-y-4 md:space-y-8">
        ...
        <div className="block space-y-4 md:hidden">
          <p className="text-xl md:text-2xl">{festival2025Data.programme[0].text}</p>
          ...
          />
          <div className="border-b border-gray-300" />
          <h4 className="text-xl md:text-2xl">{festival2025Data.programme[1].text}</h4>
          <div className="border-b border-gray-300" />
          <ProgrammeStep

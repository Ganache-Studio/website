...
export const metadata: Metadata = generateDefaultMetadata(metadataConfig['/film-musique']);

export default async function FilmMusiquePage() {
  return <FilmsPresentation filmType={filmsTypes.musique} />;
}
